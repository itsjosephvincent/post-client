<template>
    <div class="relative h-screen isolate bg-gray-900">
        <div class="mx-auto grid max-w-7xl grid-cols-1 lg:grid-cols-2">
            <div class="relative px-6 pb-20 pt-24 sm:pt-32 lg:static lg:px-8 lg:py-48">
                <div class="mx-auto max-w-xl lg:mx-0 lg:max-w-lg">
                    <div
                        class="absolute inset-y-0 left-0 -z-10 w-full overflow-hidden bg-gray-900 ring-1 ring-white/10 lg:w-1/2">
                        <svg aria-hidden="true"
                            ...
                            <rect width="100%" height="100%" fill="url(#83fd4e5a-9d52-42fc-97b6-718e5d7ee527)"
                                stroke-width="0" />
                        </svg>
                        <div aria-hidden="true"
                            class="absolute -left-56 top-[calc(100%-13rem)] block transform-gpu blur-3xl lg:left-[max(-14rem,calc(100%-59rem))] lg:top-[calc(50%-7rem)]">
                    ...
                    <h2 class="text-pretty text-4xl font-semibold tracking-tight text-white sm:text-5xl">Get in touch
                    </h2>
                    <p class="mt-6 text-lg/8 text-gray-400">Proin volutpat consequat porttitor cras nullam gravida at.
                        ...
                        <div class="flex gap-x-4">
                            <dt class="flex-none">
                                ...
                                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"
                                    data-slot="icon" aria-hidden="true" class="h-7 w-6 text-gray-400">
                                    <path
                                        d="M2.25 21h19.5m-18-18v18m10.5-18v18m6-13.5V21M6.75 6.75h.75m-.75 3h.75m-.75 3h.75m3-6h.75m-.75 3h.75m-.75 3h.75M6.75 21v-3.375c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125V21M3 3h12m-.75 4.5H21m-3.75 3.75h.008v.008h-.008v-.008Zm0 3h.008v.008h-.008v-.008Zm0 3h.008v.008h-.008v-.008Z"
                                        stroke-linecap="round" stroke-linejoin="round" />
                                </svg>
                            </dt>
                            <dd>Datu Taganiyog St.<br />Island Garden City of Samal, 8119</dd>
                        </div>
                        <div class="flex gap-x-4">
                            <dt class="flex-none">
                            ...
                            <dd><a href="tel:+1 (555) 234-5678" class="hover:text-white">+63 948 271 7449</a></dd>
                        </div>
                        <div class="flex gap-x-4">
                            <dt class="flex-none">
                            ...
                            <dd>
                                <a href="mailto:praservices@gmail.com"
                                    class="hover:text-white">praservices@gmail.com</a>
                            </dd>
                        </div>
                    </dl>
                </div>
